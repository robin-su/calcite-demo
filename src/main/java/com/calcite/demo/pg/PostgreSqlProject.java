...
public class PostgreSqlProject extends Project implements IPostgreSqlRel {
    ...
    protected PostgreSqlProject(RelOptCluster cluster,
                                RelTraitSet traits,
                                RelNode input,
    ...
    public void implement(Implementor implementor) {
        ...
        PostgreSqlRules.RexToPostgreSqlTranslator translator = new PostgreSqlRules.RexToPostgreSqlTranslator(
                PostgreSqlRules.postgreSqlFieldNames(getInput().getRowType())
        );
